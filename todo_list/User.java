...
public class User {
    ...
    // Constructor
    public User(String firstname){  //Constructeur de la classe User / appelé quand on crée un nouvel objt User - prend en param prénom de l'user  + donne un id unique à l'user en utilisant nextId
    ...
    // Equals -> Comparer TODO Pourquoi a t'on besoin de faire ça ?
    @Override  // ??
